            ...
            "produtos": [
                {
                    ...
                    "type": "tinto",
                    "grape": "Cabernet Franc, Petit, Cabernet Souvignon, Merlot, Verdot",
            ...
            "produtos": [
                {
                    ...
                    "price": 1692.83,
                    "description": "O Vinho Gaja Barolo Dagromis é uma obra-prima de Angelo Gaja. Uma homenagem à família Gromis, de quem Gaja adquiriu a propriedade em 1995. Concentrado e, ao mesmo tempo, muito elegante, apresenta camadas de aromas, intercalando frutas vermelhas, especiarias, alcaçuz, ervas, flores e toques balsâmicos. Com taninos sedosos e um longo final, é um Vinho Tinto de altíssimo nível.",
        ...
        },
        {
            ...
            "produtos": [
                ...
                },
                {
                    ...
                    "name": "Pingus 2015",
                    "price": 14000.00,
                    "description": "O Vinho Pingus é um dos melhores, e mais caros, vinhos do mundo! Lançado em 1995, foi o primeiro rótulo da Denominação de Origem (D.O.) de Ribeira del Duero a conquistar a pontuação perfeita do crítico Robert Parker. Produzido pelo Dominio de Pingus, do enólogo dinamarquês Peter Sisseck, com a uva Tinta del País, nome pelo qual a Tempranillo é conhecida na região, oriunda de vinhas velhas, plantadas em 1929. De coloração granada intensa, revela, no nariz, aromas de frutas vermelhas maduras, como de cereja e framboesa, notas florais, como de violeta e lilás, nuances de especiarias e toques minerais. Um Vinho Tinto de grande estrutura e concentração. Em boca, apresenta taninos refinados, ótima acidez e um final longo e persistente. O Pingus 2015 conta com um excelente potencial de guarda, podendo envelhecer por décadas, aproveite, pois foram produzidas apenas 6.900 garrafas deste grande vinho!",
            ...
            "produtos": [
                {
                    ...
                    "price": 11423.30,
                    "description": "Quem oferece uma infinidade de sabores complexos e equilibrados que geram ainda mais harmonias ao longo do tempo. Este belo vinho doce apresenta um carácter forte, mas nunca autoritário, com grande elegância e equilíbrio.",
            ...
            "produtos": [
                {
                    ...
                    "price": 3443.63,
                    "description": "Este Chardonnay italiano é considerado um dos melhores brancos da Itália, com capacidade de envelhecer por mais de 10 anos. Robert Parker compara sua qualidade aos Grand Crus de Puligny-Montrachet, na Borgonha, devido à sua sofisticação. O vinho é uma homenagem a Gaia, filha de Angelo Gaja, e sua avó, Clothilde Rey. Potente, elegante e refinado, ele é maturado em barricas novas e de segundo uso, resultando em um vinho complexo e encorpado, sem perder a vivacidade da fruta. Com o tempo, desenvolve notas elegantes de mel e amêndoas.",
                    "winemaking": "A vinificação tradicional deste vinho é realizada com uvas cuidadosamente selecionadas e fermentadas em tanques de aço inoxidável sob controle rigoroso de temperatura, variando entre 16°C e 18°C, durante um período de quatro semanas. A fermentação malolática ocorre naturalmente após a fermentação alcoólica, contribuindo para a suavização da acidez e a adição de textura ao vinho. Todo o processo é conduzido com precisão para garantir a preservação da pureza da fruta e a expressão do terroir, resultando em um vinho equilibrado e complexo.",
        ...
        },
        {
            ...
            "produtos": [
                ...
                },
                {
                    ...
                    "price": 2003.38,
                    "description": "La Grande Année, considerado o melhor Champagne de 2020 pela Wine Spectator e um dos 10 melhores vinhos do mundo, também é altamente elogiado por críticos como Robert Parker e Jancis Robinson. Feito com uma grande proporção de Pinot Noir e fermentado em barricas de carvalho, é um champanhe encorpado e complexo. As uvas são selecionadas exclusivamente de vinhedos Grand Cru e Premier Cru, garantindo uma qualidade excepcional. O processo de autólise de 6 anos contribui para sua complexidade e longevidade, tornando-o um dos champanhes mais prestigiados no mundo.",
            ...
            "produtos": [
                {
                    ...
                    "price": 466.00,
                    "description": "O Espumante Ferrari Trento Maximum Brut é elaborado pela famosa vinícola Ferrari, na região de Trentino-Alto Ádige, no norte da Itália. No nariz, revela notas tostadas combinadas a toques de maçã, frutas cítricas e de biscoito. Em boca, é cremoso e persistente, com acidez vibrante e perlage refinada.",
            ...
            "produtos": [
                {
                    ...
                    "price": 827.73,
                    "description": "Uma verdadeira obra prima da arte de combinar diversos vinhos envelhecidos, que na média  têm aproximadamente 20 anos, o Graham's 20 Years Old é mais claro e fantasticamente macio que o 10 anos. Possui um clássico bouquet de nozes e um final longo e prazeroso. Um Porto de grande classe e requinte.",
            ...
            "produtos": [
                {
                    ...
                    "name": "González Byass",
                    "price": 326.66,
                    "description": " Com uma cor mogno muito escura e intensa. Aromas muito doces de passas e caramelo, com toques de madeira. Aveludado e ricamente doce no paladar, lembra passas e tâmaras envelhecidas, com um final longo e vibrante.",
...
fastify.post('/produtos/id', async function handler(request, reply) {
    ...
    for (let i = 0; i < produtos.produtos.length; i++) {
        var allprodutos = produtos.produtos[i].produtos

        for (let x = 0; x < allprodutos.length; x++) {
            if (allprodutos[x].id == requestContent.id) {
                filter.push(allprodutos[x])
            }

        }
        // if (produtos[i].produtos == requestId) {
