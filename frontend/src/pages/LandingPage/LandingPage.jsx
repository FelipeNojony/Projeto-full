...
export default function LandingPage({ data, isOpen }) {
    ...
    const { image, name, descripition, winemaking, aboutproducer, critics, bottlesize, region, producer, alcoholcontent, country, harmonization, type, grape, servingtemperature } = data;
